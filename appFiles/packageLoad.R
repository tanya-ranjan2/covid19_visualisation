...
if (!require(shinythemes)) {install.packages("ggplot2"); library(shinythemes)}
if (!require(openintro)) {install.packages("ggplot2"); library(openintro)}
if (!require(plotly)) {install.packages("ggplot2"); library(plotly)}
